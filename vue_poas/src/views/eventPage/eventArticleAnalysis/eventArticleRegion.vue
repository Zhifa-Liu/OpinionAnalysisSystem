<template>
    <div id="eventArticleRegion">
        <span class="text" style="margin-top: 10px; display: block">事件文章地域分析</span>
        <div id="region_div">
        </div>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        methods: {
            init(){
                var region_container = document.getElementById('region_div');
            ...
            async getData() {
                const that = this;
                await axios.get('/eventArticle/articleRegionDistribute',{
                    params: {
